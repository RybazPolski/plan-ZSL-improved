...
async function getClasses(){
    ...
    try{
        await page.waitForSelector("#plan_menu")
    }catch(e){
        console.log(e)
    }
...
async function getTeachers(){
    ...
    try{
        await page.waitForSelector("#plan_plany")
    }catch(e){
        console.log(e)
    }
...
getTables().then(e=>console.log(e))

module.exports = {
    getSchooltableURL, getTeachers, getClassrooms, getClasses, getTables
}